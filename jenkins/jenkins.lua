--[[
# [Jenkins API](https://wiki.jenkins.io/display/JENKINS/Remote+access+API) connector.
...
local jenkins_url = inputVar.jenkins_url
local user = inputVar.user
local password = inputVar.password

local url = jenkins_url .. inputVar.api_endpoint
